    ...
    mapOption = {
        center: new kakao.maps.LatLng(cur_latitude,cur_longitude), // 지도의 중심좌표
        level: 1 // 지도의 확대 레벨
    };
...
var cur = new kakao.maps.LatLng(cur_latitude,cur_longitude);
...
searchDetailAddrFromCoords(cur, function(result, status) {
